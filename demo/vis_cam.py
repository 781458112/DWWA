...
def parse_args():
    ...
    parser.add_argument('--img',default='/home/zh/zhao/mmdetection-2.18/mmdetection-master/data/coco/test2017/1-29.234.jpg', help='Image file')
    parser.add_argument('--config',default='/home/zh/zhao/mmdetection-2.18/mmdetection-master/work_dirs/atss_r50_fpn_1x_coco/atss_r50_fpn_1x_coco.py', help='Config file')
    parser.add_argument('--checkpoint', default='/home/zh/zhao/mmdetection-2.18/mmdetection-master/work_dirs/atss_r50_fpn_1x_coco/epoch_23.pth',help='Checkpoint file')
    parser.add_argument(
        '--method',
        default='gradcam',
